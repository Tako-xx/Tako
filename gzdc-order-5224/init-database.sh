...
java -Dspring.datasource.url="jdbc:mysql://db.hzero.org:3306/gzdc_order?useUnicode=true&characterEncoding=utf-8&useSSL=false" \
	 -Dspring.datasource.username=root \
	 -Dspring.datasource.password=oOyTmdzxNWt1GdxX \
